...
import 'package:heal_together/createAcc2.dart';

class createAcc1 extends StatelessWidget {
                ...
                child: new Column(
                  children: <Widget>[
                    ...
                    new Container(
                      ...
                      child: new Text("Please enter your Details:-",
                    ...
                    new Expanded(child: new FittedBox(
                        ...
                        child: new Container(
                          ...
                          onPressed: (){
                            Navigator.push(context, new MaterialPageRoute(builder: (context) => new createAcc2()));
                          },
