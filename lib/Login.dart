...
import 'package:heal_together/register1.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        body: new Stack(
            fit: StackFit.expand,
            children: <Widget>[
              new Image(image: new AssetImage("images/background3.jpg"),
                fit: BoxFit.cover,)
              ,new Container(
                  child: new Column(
                            ...
                            child: new Column(
                              children: <Widget>[
                                ...
                                new Container(
                                    ...
                                    child: new Row(
                                      children: <Widget>[
                                        new Icon(Icons.screen_lock_portrait,size: 20.0,color: Colors.black38,),
                                        new Text("Please Enter your Mobile Number",style: new TextStyle(fontSize: 15.0,color: Colors.black,fontFamily: "century"),)
                                      ],
                                    )
                                ),
                                new Container(
                                ...
                                new Container(
                                    ...
                                    child: new RaisedButton(onPressed: (){
                                      Navigator.push(context, new MaterialPageRoute(builder: (context) => new Register1()));
                                    },
